...
const initialBalance = new BN('4000000000000000000000000000');

const { expect } = require('chai');

contract('WindsCoinToken - Standard', function([_, owner, recipient, anotherAccount]) {
  beforeEach(async function() {
    this.token = await WindsCoinToken.new(owner);
  });
